...
def compute_token_dirichlet_uncertainties(args, outputs, extra):
    """
...
def compute_sequence_dirichlet_uncertainties(args, outputs, extra, output_ids, output_length, mask):
    """
